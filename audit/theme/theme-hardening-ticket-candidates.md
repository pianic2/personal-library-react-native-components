...
4. Button structural component tokens are wired by PLRNUI-30; wire Input/Card component tokens before claiming the complete component-token architecture.
