...
4. Button structural component tokens are wired by PLRNUI-30 and Input structural component tokens are wired by PLRNUI-31; wire Card component tokens before claiming the complete component-token architecture.
