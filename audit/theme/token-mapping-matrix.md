...
| --- | --- | --- |
| Public components prefer semantic and component tokens | Components often use semantic tokens; Button structural component tokens are wired by PLRNUI-30; Input/Card component tokens remain declared or incomplete. | Need component-token source for Input/Card before claiming the full component-token architecture. |
