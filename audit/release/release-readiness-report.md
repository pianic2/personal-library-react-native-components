...
7. Component `stable` promotion remains blocked until docs/platform/support evidence and any required interaction/accessibility coverage are complete; PLRNUI-21, PLRNUI-22 and PLRNUI-24 only remediate targeted blockers/type visibility and do not promote components to `stable`.
