...
export function Switch({ value, onChange, label, disabled = false }: SwitchProps) {
  ...
  return (
    ...
    >
      <View style={{ width: 44, height: 24, borderRadius: 24, backgroundColor: value ? colors.primary : colors.border, padding: 2 }}>
        <View style={{ width: 20, height: 20, borderRadius: 20, backgroundColor: colors.surface, marginLeft: value ? 20 : 0 }} />
      </View>
